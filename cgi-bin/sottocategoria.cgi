...
my $tipo= $page->param('tipo');
my $categoria= $page->param('categoria');

my $query = "//$categoria/oggetto";
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="it" lang="it">
	<head>
		...
		<meta name="title" content="Sottocategorie - DaToSaAl Arredamenti"/>
		<meta name="author" content="Alberto Nicol&egrave;, Davide Tomasin, Guido Santi, Tommaso Zagni"/>
		<meta name="description" content="Sottocategoria dell'azienda DaToSaAl Arredamenti"/>
			...
			<div id="content" >
				<div class="main" >
					<div class="content-full-width" >
						<div id="breadcrumb">
							Ti trovi in: <a href="index.cgi" ><span xml:lang="en">Home</span></a> &gt; <a href="./$categoria.cgi" >$categoria</a> &gt; <span id="currentPage">$tipo</span>
						</div>
...
$number = @elemento;
for($i=0; $i <$number; $i++) {
	if($tipo eq $elemento[$i]->find("tipo")){
